...
> nianyi is a technology and product evaluation website that provides the latest technology news, product reviews, and purchase advice to help users make wise technology product choices.
...
```yml
title: Nianyi
subtitle: echnology news, product reviews, and purchase advice
description: nianyi is a technology and product evaluation website that provides the latest technology news, product reviews, and purchase advice to help users make wise technology product choices.
keywords:
# 作者名称，会显示在侧边栏
author: nianyi
```
...
```yml
card_author:
  description: echnology news, product reviews, and purchase advice
```
...
```sh
# 克隆仓库
$ git clone https://github.com/zizhudot/nianyi.comreb.com.git
# 安装依赖
$ yarn install
# 运行
$ yarn server
